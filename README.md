...
Static and mobile manipulators performing object pick and place/stack task on Python PyBullet. 
...
1. **Pick and stack legos by a (static) Franka Emika Panda manipulator with knowledge on legos positions**.
<div align="center">
<img alt="Illustration" src="pictures/pick_stack_simu_panda_low2.gif" width="80%" height="80%"> </img>
</div>

2. **Pick and stack legos by a (static) Franka Emika Panda manipulator using visual servoing to determine the legos positions** (to do).
